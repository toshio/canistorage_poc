...
function App() {
  ...
  return (
    <main>
      ...
      <p>
        Pricipalごとにディレクトリやファイルのアクセス制御を行えるため、使用するDAppごとに異なるPrincipalを用いることによって<br/>
      ...
      <p>
        ...
        このPoCは、Canisterにファイルシステム機能が実装されるまでの過渡的な仕組みにすぎません。<br/>
        将来的には、単なるファイル管理だけではなく、より抽象度の高いデータを管理するオープンなI/F仕様を取り込んでいければと思います。
      </p>
      <h2>This site</h2>
      <p>
